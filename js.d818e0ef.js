...
var Game = function Game() {
  ...
  this.displayResult = function (lastWin) {
    ...
    _this.setResultsInLocalStorage();
  };

  this.setResultsInLocalStorage = function () {
    localStorage.setItem("winX", _this.winX);
    localStorage.setItem("winO", _this.winO);
  };

  this.getResultsFromLocalStorage = function () {
    _this.winO = localStorage.getItem("winO");
    _this.winX = localStorage.getItem("winX");
    _this.winsPlayerO.textContent = _this.winO;
    _this.winsPlayerX.textContent = _this.winX;
  };
...
exports.Game = Game;
},{"./Modal.js":"src/js/Modal.js"}],"node_modules/howler/dist/howler.js":[function(require,module,exports) {
var define;
...
var music = function music() {
  ...
  var setItemInLocalStorage = function setItemInLocalStorage() {
    localStorage.setItem("isPlaying", isPlaying);
  };
  ...
  var handleMusic = function handleMusic() {
    if (isPlaying) {
      sound.play();
    } else {
      sound.stop();
...
},{"../scss/style.scss":"src/scss/style.scss","./Game.js":"src/js/Game.js","./music.js":"src/js/music.js","./toggle.js":"src/js/toggle.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
